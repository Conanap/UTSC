...
public class ContextParserTest {
  ...
  public void testGetFirstThreePublication() {
    html = "<table class=\"cit-table\">" + "<tr class=\"cit-table item\">"
        + "<td id=\"col-title\"><a href=\"#\">Hi</a>"
        + "<tr class=\"cit-table item\">"
        + "<td id=\"col-title\"><a href=\"#\">Bye</a>"
        + "<tr class=\"cit-table item\">"
        + "<td id=\"col-title\"><a href=\"#\">U wot m8</a>" + "</table>";
    cp.setHTML(html);
    assertEquals("Hi\nBye\nU wot m8\n", cp.getFirstThreePublication());
    html = "<table class=\"cit-table\">" + "<tr class=\"cit-table item\">"
        + "<td id=\"col-title\"><a href=\"#\">Hi</a>"
        + "<tr class=\"cit-table item\">"
        + "<td id=\"col-title\"><a href=\"#\">Bye</a>" + "</table>";
    cp.setHTML(html);
    assertEquals("Hi\nBye\n", cp.getFirstThreePublication());
    cp.setHTML("");
  ...
  public void testGetNumPublicationFirstFive() {
    html = "<table class=\"cit-table\">" + "<td id=\"col-citedby\"><a.*?>10</a>"
        + "</table>";
    cp.setHTML(html);
    ...
    html = "<table class=\"cit-table\">" + "<td id=\"col-citedby\"><a.*?>10</a>"
        ...
        + "<td id=\"col-citedby\"><a.*?>10</a>"
        + "<td id=\"col-citedby\"><a.*?>10</a>"
        + "<td id=\"col-citedby\"><a.*?>10</a>" + "</table>";
    cp.setHTML(html);
  ...
  public void testGetNumCoauthor() {
    html = "Co-authors" + "<a class=\"cit-dark-link\" >Hihi</a>"
        + "<a class=\"cit-dark-link\" >Byebye</a>" + "View all co-authors";
    cp.setHTML(html);
