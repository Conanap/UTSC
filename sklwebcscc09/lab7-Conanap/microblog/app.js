...
const bodyCheck = require('express-validator/check');
...
// from https://flaviocopes.com/express-validate-input/
// and https://medium.freecodecamp.org/how-to-make-input-validation-simple-and-clean-in-your-express-js-app-ea9b5ff5a8a7
// TODO: implement validation
// TODO: fix httpOnly causing not to able to get username from cookie (bc js can't read the cookie now)
app.use(function (req, res, next) {
    if (req.body) {
